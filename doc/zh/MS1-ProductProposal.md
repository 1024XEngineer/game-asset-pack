...
- **跨引擎支持**
  - 提供 Unity、Godot 等主流游戏引擎的原生 SDK 包，开发者可以通过代码调用本平台的云端素材。
- **资源获取**
  - 提供便捷的工具直接获取平台中的各类资源而无需手动下载
...
提供客户端 SDK，封装平台资源获取能力，让开发者直接在游戏代码中调用平台素材，无需手动下载与配置。
